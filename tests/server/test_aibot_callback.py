...
class TestExtractMsgId(unittest.TestCase):
    ...
    def test_extract_from_nested_text(self):
        ...
        data = {
            "msgtype": "text",
            "text": {"content": "hello", "msgid": "nested123"}
        }
        result = self.extract_msg_id(data)
    ...
    def test_extract_from_nested_image(self):
        ...
        data = {
            "msgtype": "image",
            "image": {"media_id": "xxx", "msgid": "img456"}
        }
        result = self.extract_msg_id(data)
...
class TestAPIEndpoints(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ["GEMINI_BOT_ENCODING_AES_KEY"] = "abcdefghijklmnopqrstuvwxyz0123456789ABCDEFG"
        os.environ["CHATGPT_BOT_TOKEN"] = "test_token"
        os.environ["CHATGPT_BOT_ENCODING_AES_KEY"] = "abcdefghijklmnopqrstuvwxyz0123456789ABCDEFG"
        os.environ["GROK_BOT_TOKEN"] = "test_token"
        os.environ["GROK_BOT_ENCODING_AES_KEY"] = "abcdefghijklmnopqrstuvwxyz0123456789ABCDEFG"
